...
#' @param prefix character; prefix collapsed to string by \code{sep} and 
#' added to the front of each name 
#' @param suffix character; collapsed to string by \code{sep} and 
#' added to the back of each name.
#' @param sep string used to collapse and seperate \code{prefix} or 
#' \code{suffix} from names. The default is not to use a separator.
#' @param exclude_key logical; if \code{TRUE} do not mangle the object's keys. 
#' (DEFAULT: \code{TRUE}) 
#' @param ... additional arguments
#'
#' @details 
#' 
#' \code{nm_prefix} and \code{nm_suffix} add a prefix or suffix to the names of
#' an object. 
#' 
...
#'   
#' @seealso 
#'   \code{\link[stringr.tools]{str_prefix}} which is used by these functions
#'   
#' @examples
#' 
#' # nm_prefix
...
# @note 
#    It may be advantagous to return the data.table, \code{x} here rather 
#    than invisible(NULL)
# 
#' @rdname nm_prefix
#' @import data.table
